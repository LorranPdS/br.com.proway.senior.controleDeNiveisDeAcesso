 ...
 * 
 * Os m√©todos dessa classe definem a API de nosso sistema.
 * 
...
public class Controller {
	...
	public boolean enviarEmailDeConfirmacaoDeLogin(String emailDoDestinario) throws Exception {
		...
		String corpoDoEmail = "O seu c√≥digo √©: " + codigoDeConfirmacao.toString();
	...
	/**
	 * CriaÁ„o de um {@link Usuario} no objeto.
	 * 
	 * Respons·vel por criar um objeto do tipo {@link Usuario} com os atributos login e senha.
	 * O objeto {@link Usuario} È enviado ao {@link UsuarioDAO} para ser persistido no banco de dados.
	 * 
	 * @param login
	 * @param senha
	 */
	...
	/**
	 * RemoÁ„o de um {@link Usuario} pelo id.
	 * 
	 ...
	 * 
	 * Ser· feita uma consulta do {@link Usuario} no banco de dados atravÈs do id, o qual retornar· o objeto
	 ...
	 * 
	 * Ser· feita uma consulta do {@link Usuario} no banco de dados atravÈs de seu id, o qual retornar· o objeto
	 * completo.
	 * 
	 * @param Integer - idUsuario
	 ...
	 * 
	 * Ser· feita uma consulta do {@link Usuario} no banco de dados atravÈs de seu nome, o qual retornar· o objeto
	 * completo.
	 * 
	 * @param String
	...
	/**
	 * Remo√ß√£o de um {@link Perfil} pelo id.
   *
	 * Respons√°vel por deletar um objeto do tipo {@link Perfil} com os atributos idPerfil.
	 * O objeto {@link Perfil} √© enviado ao {@link Perfil} para ser removido no banco de dados.
	 * 
	 ...
	 * 
	 * @param Integer 
	 * @throws NullPointerException Caso n√£o exista o {@link Perfil} no banco de dados.
	 * @return Perfil
	 */
	 ...
	 * 
	 * Ser· feita uma consulta da {@link Permissao} no banco de dados atravÈs do id e nome da permissao,
